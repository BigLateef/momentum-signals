...
export type SafetyReport = {
  ...
  // Most-recent raw provider response text, for debugging field-shape
  // mismatches via the Safety Report UI's "Copy report" button — not a full
  // audit log, just whatever was captured on the most recent analysis.
